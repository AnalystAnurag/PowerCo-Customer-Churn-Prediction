...
- **`client_data.csv`** — 14,606 records × 26 features: consumption, contract dates, sales channel, forecasted usage/pricing, margins, and the binary `churn` label.
- **`price_data.csv`** — 193,002 records: daily electricity pricing (peak, off-peak, mid-peak — variable and fixed) per customer for 2015–2016.
